...
<div class="main-content">
    <div class="topbar">
        <div class="search-box"><i class="fa-solid fa-magnifying-glass"></i><input type="text" id="searchTx" placeholder="Cari nomor pesanan/nama..."></div>
...
document.getElementById('searchTx').addEventListener('keyup', function() {
    ...
    let rows = document.querySelectorAll('#txTableBody tr');
