...
<div class="app-container" style="min-height: 100vh; display: flex; flex-direction: column; box-sizing: border-box;"> 
    ...
    <div style="position: sticky; bottom: 0; width: 100%; background: #ffffff; box-shadow: 0 -8px 24px rgba(0,0,0,0.08); border-radius: 16px 16px 0 0; z-index: 999; box-sizing: border-box; padding: 16px 16px 12px 16px; margin-top: auto;">
        
        <?php if (!empty($cart)): ?>
            <div class="summary-line" style="margin-bottom: 12px !important; display: flex; justify-content: space-between; align-items: center;">
                <span style="font-size: 14px; font-weight: 600; color: #555;">Total Sementara</span>
                <span class="total-price" style="font-size: 18px; font-weight: 700; color: #6B3A1E;">Rp <?= number_format($subtotal, 0, ',', '.'); ?></span>
            </div>
            <a href="<?= base_url('checkout'); ?>" class="btn-checkout" style="text-decoration: none; display: block; text-align: center; padding: 12px 0 !important; font-size: 14px !important; font-weight: 600; border-radius: 8px !important; line-height: 1.2 !important; height: auto !important; background-color: #4CAF50; color: white; margin-bottom: 14px; width: 100%; box-sizing: border-box;">Lanjut Pilih Meja</a>
